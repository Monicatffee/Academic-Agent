...
const getNameFromFacebook = (req, res) => {
        ...
        dbo.collection("pizzashop").find({ facebook_id: facebookId}).toArray(async function(err, users) {
            ...
            if(users.length > 0){
                ...
                request(`https://graph.facebook.com/v3.2/${facebookId}?fields=first_name&access_token=EAAHwi1O8TI0BAPYUcxNkKKMm36HYMewgbWQWwpNmmLipyqll7JVNZBbR4bBHz06YWyZBEvpOEZBPzvFH0iOTP16LEdZAzh381Dd1Hcp5ht4p0HbZAWugo5OVeZARnvhAx16CZCZC0fHZAZCqI8a4dsWwcXQ2P3i7217uZCWvyqqn1sW6iCxg5YKoiVN`, (error, response, body)=>{
